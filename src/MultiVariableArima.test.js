...
describe('MultiVariableArima', () => {
    jest.setTimeout(900000) // 15 minutes

    test('predicting the next multivariable bars completes', () => {
        ...
        const timeSeriesModel = new MultiVariableArima(
            historialBEPTickerData, 4,
        )
        const predictedNextBars = timeSeriesModel.predictNextBars()
    ...
    test('predicting the next single variable bars completes', () => {
        ...
        const timeSeriesModel = new MultiVariableArima(btcUsdPairData, 4)
        const predictedNextBars = timeSeriesModel.predictNextBars()
